...
> [mini-stores【推荐】](https://github.com/linjc/mini-stores) - dd-store升级版，可同时页面/组件多状态共享，功能强大且更容易上手，支持微信/支付宝/钉钉/百度/字节/QQ等小程序！
...
2、对于大项目，特别是超大型项目，状态多业务复杂，推荐使用方案三进行状态管理（或者使用[mini-stores](https://github.com/linjc/mini-stores)）。另外个人建议将页面状态和逻辑提取到store上，页面只负责处理用户事件的监听和回调，这样的好处是：
